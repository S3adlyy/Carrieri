...
public class FeedbackController implements Initializable {
    ...
    private void setupTableColumns() {
        ...
        feedbackTable.getColumns().addAll(idCol, commentaireCol, noteCol, dateCol, renduIdCol, actionCol);
    ...
    private void openFeedbackForm(Feedback feedback) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/feedbackForm.fxml"));
            ...
            dialog.setTitle(feedback == null ? "Ajouter un feedback" : "Modifier le feedback");
