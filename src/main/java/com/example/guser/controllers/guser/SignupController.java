...
public class SignupController {
    ...
    private void onGoLogin() {
        ...
        AppNavController.getInstance().show("/com/example/guser/guser/login.fxml", "Carrieri • Login");
        ...
        try (S3StorageService s3 = new S3StorageService(S3_BUCKET, S3_REGION)) {
            ...
            if ("CANDIDATE".equals(role)) {
                ...
                if (pickedProfilePicFile != null) {
                    String ext = S3KeyUtil.extNoDotOrDefault(pickedProfilePicFile.getName(), "jpg");
                ...
                if (pickedLogoFile != null) {
                    String ext = S3KeyUtil.extNoDotOrDefault(pickedLogoFile.getName(), "png");
