...
public class ModuleController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        tableModules.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                AppNavController.getInstance().setEtudeCurrentModule(newSelection.getId(), newSelection.getTitre());
            } else {
        ...
        if (confirmed) {
            try {
                ...
                if (moduleSelectionne != null && moduleSelectionne.getId() == module.getId()) {
                    AppNavController.getInstance().resetEtudeModule();
                }
    ...
    private void genererQuizAutomatique() {
        ...
        List<entities.getude.Lecon> lecons = leconService.getLeconsByModule(moduleSelectionne.getId());
