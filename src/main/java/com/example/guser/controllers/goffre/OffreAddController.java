...
import services.goffre.AIGeneratorService;
...
public class OffreAddController {
    ...
    private void handleSave() {
        ...
        int recruiterid = SessionContext.getCurrentUser().getId();
    ...
    private void applyTheme() {
        if (txtTitre != null && txtTitre.getScene() != null && txtTitre.getScene().getRoot() != null) {
            ...
            if (isDarkMode) {
                root.getStylesheets().add(getClass().getResource("/com/example/guser/goffre/css/theme-unified.css").toExternalForm());
