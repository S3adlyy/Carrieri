...
public class HelloApplication extends Application {
    ...
    private static final String CSS_LIGHT = "/com/example/guser/goffre/css/theme-unified.css";
    private static final String CSS_DARK  = "/com/example/guser/goffre/css/theme-dark.css";
    ...
    private void loadApplication() {
        try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/com/example/guser/goffre/offres-shell.fxml"));
            ...
            Platform.runLater(() -> {
                ...
                try {
                    scene.getStylesheets().add(getClass().getResource("/com/example/guser/goffre/css/alert.css").toExternalForm());
                } catch (Exception e) {
                    System.err.println("⚠️ CSS alerts non trouvé: /com/example/guser/goffre/css/alert.css");
                }
    ...
    private void createSplashScreen() {
        ...
        Label subtitleLabel = new Label("Gestion des Offres d'Emplois");
    ...
    private void addIconToStage(Stage stage) {
        try {
            stage.getIcons().add(new Image(getClass().getResourceAsStream("/com/example/guser/images/logo.png")));
        } catch (Exception e) {
            System.err.println("⚠️ Logo non trouvé pour l'icône: /com/example/guser/goffre/images/logo.png");
        }
    }
