package com.example.guser.controllers.gcommu;  // Make sure this matches your package structure
...
public class MissionShellController implements Initializable {
    ...
    public void showMessagesView() {
        loadView("/com/example/guser/gcommu/message.fxml");
        setActiveButton(btnMessages);
    }

    @FXML
    public void showContactsView() {
        loadView("/com/example/guser/gcommu/contacts-view.fxml");
        setActiveButton(btnContacts);
    }
