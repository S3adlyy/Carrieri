...
public class TraitementFormController implements Initializable {
    ...
    public void setReclamation(Reclamation reclamation) {
        ...
        if (reclamation != null) {
            ...
            adminIdField.setText(reclamation.getUtilisateurId().toString());
        }
    }
    ...
    private void goToTraitementList() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/guser/greclam/traitementList.fxml"));
    ...
    private void goBackToList() {
        try {
            Parent listPage = FXMLLoader.load(getClass().getResource("/com/example/guser/greclam/traitementList.fxml"));
            reponseArea.getScene().setRoot(listPage);
        } catch (Exception e) {
            e.printStackTrace();
        }
