...
public class AIGeneratorService {
    ...
    public static String generateTitleImprovement(
        ...
        try {
            ...
            if (responseJson.getBoolean("success")) {
                String titreAmeliore = responseJson.getString("description").trim();
