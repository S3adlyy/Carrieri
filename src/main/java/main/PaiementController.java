...
public class PaiementController {
    ...
    private CandidatShellController parentController;

    public void setCours(Cours cours, int candidatId, CandidatShellController parent) {
        this.cours = cours;
    ...
    private void retourAuCatalogue() {
        ...
        if (parentController != null) {
            parentController.showCatalogue();
        }
    }
}